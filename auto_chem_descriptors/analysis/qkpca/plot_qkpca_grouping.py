...
def plot_qkpca_grouping(X_pca, explained_variance_ratio, analysis):
    ...
    feature_map = analysis["qkpca"]["feature_map"]
    entanglement = analysis["qkpca"]["entanglement"]
    plt.title('QKPCA: FQK, ' + feature_map + ', entanglement: ' + entanglement)
    ...
    plt.savefig('plot_qkPCA_grouping.png',  bbox_extra_artists=(lgd,), bbox_inches='tight', dpi=300)
    plt.close()
